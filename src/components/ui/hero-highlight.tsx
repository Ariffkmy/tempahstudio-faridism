...
export const Highlight = ({ children, className, ...props }: HTMLMotionProps<"span">) => {
  return (
    <motion.span
      ...
      className={cn(
        "relative inline-block bg-gradient-to-r from-primary via-primary/90 to-primary bg-[length:200%_auto] px-2 py-1 text-primary-foreground shadow-[inset_0_1px_0_rgba(255,255,255,0.3),0_2px_4px_rgba(0,0,0,0.3),0_4px_8px_rgba(0,0,0,0.1)]",
        className
      )}
      {...props}
    >
